...
type GreeterClient interface {
	GetStream(ctx context.Context, in *SteamReqData, opts ...grpc.CallOption) (Greeter_GetStreamClient, error)
...
func (c *greeterClient) GetStream(ctx context.Context, in *SteamReqData, opts ...grpc.CallOption) (Greeter_GetStreamClient, error) {
...
func (x *greeterPutStreamClient) Send(m *SteamReqData) error {
...
func (x *greeterAllStreamClient) Send(m *SteamReqData) error {
	return x.ClientStream.SendMsg(m)
}
...
type GreeterServer interface {
	GetStream(*SteamReqData, Greeter_GetStreamServer) error
...
func (UnimplementedGreeterServer) GetStream(*SteamReqData, Greeter_GetStreamServer) error {
...
func (x *greeterPutStreamServer) Recv() (*SteamReqData, error) {
	m := new(SteamReqData)
...
func (x *greeterAllStreamServer) Recv() (*SteamReqData, error) {
	m := new(SteamReqData)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
